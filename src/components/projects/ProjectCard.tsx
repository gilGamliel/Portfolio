 ...
 * Displays project thumbnail, title, description, and tech stack.
 */
    ...
    >
      <article className="h-full bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-gray-300 dark:hover:border-gray-700 hover:-translate-y-1">
        ...
        <div className="p-5">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 line-clamp-2 min-h-[40px]">
            {shortDescription}
          </p>
          ...
          {techStack && techStack.length > 0 && (
            <div className="mt-4">
              <TagList tags={techStack.slice(0, 4)} />
              {techStack.length > 4 && (
